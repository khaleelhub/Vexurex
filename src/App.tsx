      ...
      <div data-aos="fade-left">
        <div className="discriptionsText">
          ...
          <h5 className="h5">
            ...
            Designed with a focus on user-friendliness and eco-conscious
            technology, Vexurex makes digital transactions fast, secure, and
            accessible to everyone. Join the future of finance — powered by
            Vexurex.
          </h5>
        </div>
      </div>
